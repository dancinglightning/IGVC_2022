...
class opencv_algo():
    ...
    def markLocalGoal(self, x_array,y_array, warped):
        ...
        dist = -120 #-150 #-130   # tunable parameter!  
        poly_derivative = np.polyder(poly)
        # print(poly_derivative)
        print(np.sin(np.arctan(poly_derivative(new_y))))
        print(np.cos(np.arctan(poly_derivative(new_y))))      
        # print(np.arctan(poly_derivative(new_y)))
        ...
        # print("y: ", new_y_offset)                 ##################################################################
        # print("x: ", new_x_offset)                 ##################################################################        
