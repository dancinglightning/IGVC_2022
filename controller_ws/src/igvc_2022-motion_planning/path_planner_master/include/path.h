...
class Path {
  ...
  */
  ...
  void clear();
  /// Publishes the path
  void publishPath() { if(!path.poses.empty()) pubPath.publish(path); }
  /// Publishes the nodes of the path
  void publishPathNodes() { if(!pathNodes.markers.empty()) pubPathNodes.publish(pathNodes); }
  /// Publishes the vehicle along the path
  void publishPathVehicles() { if(!pathVehicles.markers.empty()) pubPathVehicles.publish(pathVehicles); }
