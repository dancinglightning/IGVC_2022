...
std::cout<<"transformed link"<<std::endl;
    ...
    //new
    // geometry_msgs::PoseStamped start_var;

    // start_var.pose = start.pose.pose;
    // start_var.header.frame_id = "map";
    // start_var.header.stamp = ros::Time::now();
...
void Planner::plan() {
  ...
  if (validStart && validGoal) {
    ...
    //Node2D nGoal_a(500, 450, t, 0, nullptr);
     const Node3D nGoal(x, y, t, 0, 0, nullptr);
    // __________
    // DEBUG GOAL
    ...
    //Node2D nStart_a(1000, 250, 0, 0, nullptr);
    Node3D nStart(x, y, t, 0, 0, nullptr);
    // ___________
    // DEBUG START
       //Node3D nStart(1058.291, 30.1081, 0, 0, 0, nullptr);
