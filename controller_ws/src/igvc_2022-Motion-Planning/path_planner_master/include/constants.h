...
static const float cellSize = 0.3;   //true value = 1
/*!
...
*/
static const float tieBreaker = 0.001;   // original value = 0.01
...
static const float penaltyTurning =0.9; //0.95; // original value 1.05
/// [#] --- A movement cost penalty for reversing (choosing motion primitives > 2)
static const float penaltyReversing = 2;//2.0;
/// [#] --- A movement cost penalty for change of direction (changing from primitives < 3 to primitives > 2)
static const float penaltyCOD = 2.0;   // original value 2.0
/// [m] --- The distance to the goal when the analytical solution (Dubin's shot) first triggers
static const float dubinsShotDistance = 100; // original value 100
/// [m] --- The step size for the analytical solution (Dubin's shot) primarily relevant for collision checking
static const float dubinsStepSize = 1; //original value 1
...
static const int dubinsWidth = 15;   /// original  value = 15
...
static const int positionResolution = 10;  // true  value = 10
