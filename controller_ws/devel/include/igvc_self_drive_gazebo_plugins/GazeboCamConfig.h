...
namespace igvc_self_drive_gazebo_plugins
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(GazeboCamConfig &config, const GazeboCamConfig &max, const GazeboCamConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const GazeboCamConfig &config1, const GazeboCamConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, GazeboCamConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const GazeboCamConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, GazeboCamConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const GazeboCamConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const GazeboCamConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, GazeboCamConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
